...
to quickly create a Cobra application.`,
	...
	// 	fmt.Println("Hello from fewidentity!")
	// },
}
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.fewidentity.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".fewidentity" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigType("yaml")
		viper.SetConfigName(".fewidentity")
	}
